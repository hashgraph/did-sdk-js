...
describe("HcsDidCreateDidOwnerEvent", () => {
    ...
    describe("#constructor", () => {
        ...
        it("throws error if id is null", () => {
            let error;
            try {
                new HcsDidCreateDidOwnerEvent(<any>null, identifier, privateKey.publicKey);
            } catch (err) {
                error = err;
            }
        ...
        it("throws error if controller is null", () => {
            let error;
            try {
                new HcsDidCreateDidOwnerEvent(identifier + "#did-root-key", <any>null, privateKey.publicKey);
            } catch (err) {
                error = err;
            }
        ...
        it("throws error if publicKey is null", () => {
            let error;
            try {
                new HcsDidCreateDidOwnerEvent(identifier + "#did-root-key", identifier, <any>null);
            } catch (err) {
                error = err;
            }
