...
describe('Hcs Did Method Operations', function() {
    before(async function() {
        ...
        hcsDid = testBase.didNetwork.generateDid(false);
    ...
    it('Test Update', async function() {
        ...
        const publicKeys = rootObject[DidDocumentJsonProperties.PUBLIC_KEY];
        publicKeys.push(JSON.parse("{"
            + "\"id\": \"did:example:123456789abcdefghi#keys-2\","
            + "\"type\": \"Ed25519VerificationKey2018\","
            + "\"controller\": \"did:example:pqrstuvwxyz0987654321\","
            + "\"publicKeyBase58\": \"H3C2AVvLMv6gmMNam3uVAjZpfkcJCwDwnZn6z3wXmqPV\""
            + "}"));
        rootObject[DidDocumentJsonProperties.PUBLIC_KEY] = publicKeys;
